...
return [
    ...
    'timestamp' => 1621420212,
    'checksum' => 'ee4be4beab4dde22a05ff9b9ee5cdc96',
    'files' => [
        ...
        'user/themes' => [
            ...
            'themes/photographer' => [
                'file' => 'user/themes/photographer/blueprints.yaml',
                'modified' => 1612809470
            ],
            'themes/quark' => [
    ...
    'data' => [
        'items' => [
            ...
            'themes.photographer.dropdown' => [
                'type' => '_parent',
                'name' => 'themes.photographer.dropdown',
                'form_field' => false
            ],
            'themes.photographer.dropdown.enabled' => [
                'type' => 'toggle',
                'label' => 'Dropdown in navbar',
                'highlight' => 1,
                'default' => 1,
                ...
                'name' => 'themes.photographer.dropdown.enabled',
                'validation' => 'loose'
            ],
            'themes.photographer.color' => [
                'type' => 'text',
                'label' => 'Color',
                'default' => 'blue',
                'validate' => [
                ...
                'name' => 'themes.photographer.color',
                'validation' => 'loose'
            ],
            'themes.quark' => [
                'type' => '_root',
        ...
        'nested' => [
            ...
            'themes' => [
                ...
                'photographer' => [
                    'dropdown' => [
                        'enabled' => 'themes.photographer.dropdown.enabled'
                    ],
                    'color' => 'themes.photographer.color'
                ],
                'quark' => [
